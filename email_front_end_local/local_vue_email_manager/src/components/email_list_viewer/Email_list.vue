<script>
import Email_list_element from './Email_list_element.vue';
...
<template >
    <div id="container_documents_match_list" class="divide-y-2 divide-dashed w-4/12">
        <Paginator 
...
<style>
#container_documents_match_list {
    max-height: 75vh;
    overflow-y: auto;
    overflow-x: hidden;
}
